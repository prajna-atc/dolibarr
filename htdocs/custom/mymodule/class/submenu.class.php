...
/**
 * \file        class/submenu.class.php
 * \ingroup     mymodule
 * \brief       This file is a CRUD class file for SubMenu (Create/Read/Update/Delete)
 */
 ...
 * Class for SubMenu
 */
class SubMenu extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'submenu';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'mymodule_submenu';
	/**
	 * @var int  Does submenu support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var int  Does submenu support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;
	/**
	 * @var string String with name of icon for submenu. Must be the part after the 'object_' into object_submenu.png
	 */
	public $picto = 'submenu@mymodule';
	 ...
	 */
	//public $table_element_line = 'submenudet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_submenu';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'SubMenuline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('submenudet');
	/**
	 * @var SubMenuLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object SubMenuLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("SubMenu") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/mymodule/submenu_card.php',1).'?id='.$this->id;
...
/**
 * Class SubMenuLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class SubMenuLine
{

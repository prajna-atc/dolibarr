...
/**
 * \file    test/functional/SalesOrderFunctionalTest.php
 * \ingroup salesorder
...
/**
 * Class SalesOrderFunctionalTest
 *
 ...
 *
 * @package Testsalesorder
 */
class SalesOrderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSalesOrder')->click();
		} else {
			// Disable the module
			$this->byHref('modSalesOrder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/salesorder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('salesorder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/salesorder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('salesorder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('salesorderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSalesOrder_SalesOrderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSalesOrder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

...
dol_include_once("/salesorder/class/myobject.class.php");


/**
 * mailing_mailinglist_salesorder
 */
class mailing_mailinglist_salesorder_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_salesorder_myobject';
	...
	var $picto='salesorder@salesorder';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('salesorder',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/salesorder/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_salesorder_myobject.modules.php: mailing ".$num." targets found");

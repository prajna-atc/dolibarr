...
/**
 * \file    modulebuilder/template/core/boxes/salesorderwidget1.php
 * \ingroup salesorder
 * \brief   Widget provided by SalesOrder
 *
 ...
 */
class salesorderwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "salesorderbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "salesorder@salesorder";
	 ...
	 */
	public $depends = array('salesorder');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->salesorder->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("SalesOrderBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_salesorder@salesorder',

...
/**
 *	\file       htdocs/salesorder/template/salesorderindex.php
 *	\ingroup    salesorder
 *	\brief      Home page of salesorder top menu
 */
...
$langs->loadLangs(array("salesorder@salesorder"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->salesorder->read) accessforbidden();
...
llxHeader("",$langs->trans("SalesOrderArea"));

print load_fiche_titre($langs->trans("SalesOrderArea"),'','salesorder.png@salesorder');
...
// Draft MyObject
if (! empty($conf->salesorder->enabled) && $user->rights->salesorder->read)
{
	$langs->load("orders");

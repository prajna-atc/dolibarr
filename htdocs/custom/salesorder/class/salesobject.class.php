...
/**
 * \file        class/salesobject.class.php
 * \ingroup     salesorder
 * \brief       This file is a CRUD class file for SalesObject (Create/Read/Update/Delete)
 */
...
/**
 * Class for SalesObject
 */
class SalesObject extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'salesobject';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'salesorder_salesobject';
	/**
	 * @var int  Does salesobject support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var int  Does salesobject support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;
	/**
	 * @var string String with name of icon for salesobject. Must be the part after the 'object_' into object_salesobject.png
	 */
	public $picto = 'salesobject@salesorder';
	 ...
	 */
	//public $table_element_line = 'salesobjectdet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_salesobject';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'SalesObjectline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('salesobjectdet');
	/**
	 * @var SalesObjectLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object SalesObjectLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("SalesObject") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/salesorder/salesobject_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowSalesObject");
            ...
            /*
             $hookmanager->initHooks(array('salesobjectdao'));
...
/**
 * Class SalesObjectLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class SalesObjectLine
{
	// @var int ID
	public $id;

...
dol_include_once("/supplierorderfromorder/class/myobject.class.php");


/**
 * mailing_mailinglist_supplierorderfromorder
 */
class mailing_mailinglist_supplierorderfromorder_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_supplierorderfromorder_myobject';
	...
	var $picto='supplierorderfromorder@supplierorderfromorder';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('supplierorderfromorder',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/supplierorderfromorder/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_supplierorderfromorder_myobject.modules.php: mailing ".$num." targets found");

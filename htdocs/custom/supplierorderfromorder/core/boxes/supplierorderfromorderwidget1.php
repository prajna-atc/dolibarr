...
/**
 * \file    modulebuilder/template/core/boxes/supplierorderfromorderwidget1.php
 * \ingroup supplierorderfromorder
 * \brief   Widget provided by SupplierOrderFromOrder
 *
 ...
 */
class supplierorderfromorderwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "supplierorderfromorderbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "supplierorderfromorder@supplierorderfromorder";
	 ...
	 */
	public $depends = array('supplierorderfromorder');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->supplierorderfromorder->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/supplierorderfromorder/class/supplierorderfromorder.class.php";

		// Populate the head at runtime
		$text = $langs->trans("SupplierOrderFromOrderBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_supplierorderfromorder@supplierorderfromorder',

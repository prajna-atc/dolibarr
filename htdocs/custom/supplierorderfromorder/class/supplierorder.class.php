...
/**
 * \file        class/supplierorder.class.php
 * \ingroup     supplierorderfromorder
 * \brief       This file is a CRUD class file for SupplierOrder (Create/Read/Update/Delete)
 */
...
/**
 * Class for SupplierOrder
 */
class SupplierOrder extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'supplierorder';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'supplierorderfromorder_supplierorder';
	/**
	 * @var int  Does supplierorder support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var int  Does supplierorder support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;
	/**
	 * @var string String with name of icon for supplierorder. Must be the part after the 'object_' into object_supplierorder.png
	 */
	public $picto = 'supplierorder@supplierorderfromorder';
	 ...
	 */
	//public $table_element_line = 'supplierorderdet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_supplierorder';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'SupplierOrderline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('supplierorderdet');
	/**
	 * @var SupplierOrderLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object SupplierOrderLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("SupplierOrder") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/supplierorderfromorder/supplierorder_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowSupplierOrder");
	...
	function LibStatut($status, $mode=0)
	{
		...
		{
			global $langs;
			//$langs->load("supplierorderfromorder");
...
/**
 * Class SupplierOrderLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*

...
/**
 * \file    test/functional/SupplierOrderFromOrderFunctionalTest.php
...
/**
 * Class SupplierOrderFromOrderFunctionalTest
 *
 ...
 *
 * @package Testsupplierorderfromorder
 */
class SupplierOrderFromOrderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSupplierOrderFromOrder')->click();
		} else {
			// Disable the module
			$this->byHref('modSupplierOrderFromOrder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/supplierorderfromorder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('supplierorderfromorder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/supplierorderfromorder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('supplierorderfromorder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('supplierorderfromorderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSupplierOrderFromOrder_SupplierOrderFromOrderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSupplierOrderFromOrder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

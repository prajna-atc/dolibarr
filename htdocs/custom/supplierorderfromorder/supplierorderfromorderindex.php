...
/**
 *	\file       htdocs/supplierorderfromorder/template/supplierorderfromorderindex.php
 *	\ingroup    supplierorderfromorder
 *	\brief      Home page of supplierorderfromorder top menu
 */
...
$langs->loadLangs(array("supplierorderfromorder@supplierorderfromorder"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->supplierorderfromorder->read) accessforbidden();
...
llxHeader("",$langs->trans("SupplierOrderFromOrderArea"));

print load_fiche_titre($langs->trans("SupplierOrderFromOrderArea"),'','supplierorderfromorder.png@supplierorderfromorder');
...
// Draft MyObject
if (! empty($conf->supplierorderfromorder->enabled) && $user->rights->supplierorderfromorder->read)
{
	$langs->load("orders");

...
if (empty($reshook))
{
	...
	else if ($action == 'confirm_continue' && $confirm == 'yes' && $user->rights->commande->creer)
	{
	...
	// Add a new line
	else if ($action == 'addlines' && $user->rights->commande->creer)
	{
		...
		//$TypeId = $object->thirdparty->typent_id;
		
		//print '<pre>';
		//print_r($object);
		//print '</pre>';
		// exit;
		//print $product_desc.'*1*'.$price_ht.'*2*'.$price_ht_devise.'*3*'.$prod_entry_mode.'*4*'.$tva_tx.'*5*'.$idprod.'*6*'.$qty; exit;
		...
		//}
		//$prod = new Product($db);
		//$res = $prod->test($idprod,$CustomerId);
		//$form = new Form($db);
		//if($res){
		//$formconfirm = '';	
			//echo '<script language="javascript">';
			//echo 'alert("This Product was already Ordered")';
			//echo '</script>';	
		...
		//$res = $prodcomb->checkProductOrderedBefore($CustomerId);
...
exit; */
	...
	}else if ($action == 'confirm_addline' && $confirm == 'yes')
	{
		$langs->load('errors');
		$error = 0;
		...
		//$form = new Form($db);
			if($res){
				...
				$formquestion = array(
								...
								// => 1),
								array('type' => 'hidden','name' => 'prod_entry_mode','label' => 'prod_entry_mode','value' => GETPOST('prod_entry_mode')),
								array('type' => 'hidden','name' => 'qty','label' => 'qty','value' => GETPOST('qty' . $predef)),
								array('type' => 'hidden','name' => 'type','label' => 'type','value' => GETPOST('type')),
								array('type' => 'hidden','name' => 'remise_percent','label' => 'remise_percent','value' => GETPOST('remise_percent')),
								array('type' => 'hidden','name' => 'price_ht','label' => 'price_ht','value' => GETPOST('price_ht')),
								array('type' => 'hidden','name' => 'multicurrency_price_ht','label' => 'multicurrency_price_ht','value' => GETPOST('multicurrency_price_ht')),
								array('type' => 'hidden','name' => 'price_ttc','label' => 'price_ttc','value' => GETPOST('price_ttc')),
								array('type' => 'hidden','name' => 'tva_tx','label' => 'tva_tx','value' => GETPOST('tva_tx')),								
								array('type' => 'hidden','name' => 'product_ref','label' => 'product_ref','value' => GETPOST('product_ref')),
								array('type' => 'hidden','name' => 'product_label','label' => 'product_label','value' => GETPOST('product_label')),
								array('type' => 'hidden','name' => 'product_desc','label' => 'product_desc','value' => GETPOST('product_desc')),
								array('type' => 'hidden','name' => 'fournprice','label' => 'fournprice','value' => GETPOST('fournprice')),
								array('type' => 'hidden','name' => 'buying_price','label' => 'buying_price','value' => GETPOST('buying_price')),
								array('type' => 'hidden','name' => 'np_marginRate','label' => 'np_marginRate','value' => GETPOST('np_marginRate')),
								array('type' => 'hidden','name' => 'np_markRate','label' => 'np_markRate','value' => GETPOST('np_markRate')),
								array('type' => 'hidden','name' => 'dp_desc','label' => 'dp_desc','value' => GETPOST('dp_desc')),
								array('type' => 'hidden','name' => 'idprod','label' => 'idprod','value' => GETPOST('idprod')),
								array('type' => 'hidden','name' => 'units','label' => 'units','value' => GETPOST('units')),

								array('type' => 'hidden','name' => 'date_starthour','label' => 'date_starthour','value' => GETPOST('date_starthour')),
								array('type' => 'hidden','name' => 'date_startmin','label' => 'date_startmin','value' => GETPOST('date_startmin')),
								array('type' => 'hidden','name' => 'date_startsec','label' => 'date_startsec','value' => GETPOST('date_startsec')),
								array('type' => 'hidden','name' => 'date_startday','label' => 'date_startday','value' => GETPOST('date_startday')),
								array('type' => 'hidden','name' => 'date_startmonth','label' => 'date_startmonth','value' => GETPOST('date_startmonth')),
								array('type' => 'hidden','name' => 'date_startyear','label' => 'date_startyear','value' => GETPOST('date_startyear')),
								array('type' => 'hidden','name' => 'date_endhour','label' => 'date_endhour','value' => GETPOST('date_endhour')),
								array('type' => 'hidden','name' => 'date_endmin','label' => 'date_endmin','value' => GETPOST('date_endmin')),
								array('type' => 'hidden','name' => 'date_endsec','label' => 'date_endsec','value' => GETPOST('date_endsec')),
								array('type' => 'hidden','name' => 'date_endday','label' => 'date_endday','value' => GETPOST('date_endday')),
								array('type' => 'hidden','name' => 'date_endmonth','label' => 'date_endmonth','value' => GETPOST('date_endmonth')),
								array('type' => 'hidden','name' => 'date_endyear','label' => 'date_endyear','value' => GETPOST('date_endyear')),
				...
				//print $lineid; exit;		
				$formconfirm=$form->formconfirm($_SERVER["PHP_SELF"].'?id='.$object->id.'&lineid='.$lineid, $langs->trans('AddProductLine'), $langs->trans('ConfirmAddProductLine'), 'confirm_addline',$formquestion, 1, 1);
				//	print $formconfirm;
			}else{
				//	$action == 'confirm_clone' && $confirm == 'yes' && $user->rights->commande->creer
				$langs->load('errors');
				$error = 0;
		...
		*/
		...
		if ($action != 'presend' && $action != 'editline') {
			...
			if (empty($reshook)) {
				...
				// Added by Prajna
				if (($conf->global->MAIN_MODULE_SUPPLIERORDERFROMORDER == 1 && $object->statut > Commande::STATUS_DRAFT)) {
						print '<div class="inline-block divButAction">
						<a class="butAction" href="' . DOL_URL_ROOT . '/custom/supplierorderfromorder/supplierorder_list.php?id=' . $object->id . '">Create Supplier Order </a></div>';
				}

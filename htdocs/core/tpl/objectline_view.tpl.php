...
<tr <?php echo 'id="row-'.$line->id.'" '.$bcdd[$var]; echo $domData; ?> >
    ...
    <?php }
  	...
  	<?php if (!empty($conf->global->CUSTOM_PRODUCT_PROFITMARGIN) && !empty($conf->global->CUSTOM_PRODUCT_REBATE))
                {
//added by Prajna
                 ?>                 
		<td><?php $coldisplay++; ?><?php echo $line->rebate; ?></td>
		<td><?php $coldisplay++; ?><?php echo $line->profit_margin_rate.'%'; ?></td>
	<?php } ?>

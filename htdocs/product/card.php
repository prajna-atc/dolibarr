...
else
{
    ...
    else if ($object->id > 0)
    {
		...
		print '&nbsp; ';
            ...
            // Added by Prajna
            // Added by Prajna
            if (! empty($conf->global->CUSTOM_PRODUCT_PROFITMARGIN))
            {
                if (! empty($object->profit_margin_rate))
                {
                    print '<tr><td>Profit Margin Rate</td><td colspan="3"><input name="label" class="minwidth300 maxwidth400onsmartphone" maxlength="255" value="'.dol_escape_htmltag($object->profit_margin_rate).'"></td></tr>';
                }else{
                    print '<tr><td>Profit Margin Rate</td><td colspan="3"><input name="label" class="minwidth300 maxwidth400onsmartphone" maxlength="255" value="'.dol_escape_htmltag( $conf->global->CUSTOM_PRODUCT_PROFITMARGIN).'"></td></tr>';                
                }
            }

            // Added by Prajna
            if (! empty($conf->global->CUSTOM_PRODUCT_REBATE))
            {
                if (! empty($object->rebate))
                {
                    print '<tr><td>Rebate</td><td colspan="3"><input name="label" class="minwidth300 maxwidth400onsmartphone" maxlength="255" value="'.dol_escape_htmltag($object->rebate).'"></td></tr>';                  
                }else{
                     print '<tr><td>Rebate</td><td colspan="3"><input name="label" class="minwidth300 maxwidth400onsmartphone" maxlength="255" value="'.dol_escape_htmltag($conf->global->CUSTOM_PRODUCT_REBATE).'"></td></tr>';                
                }
            }
        ...
        else
		{
            ...
            if (! empty($conf->global->CUSTOM_PRODUCT_PROFITMARGIN))
            {
                if (! empty($object->profit_margin_rate))
                {
                    print '<tr><td class="tdtop">Profit Margin Rate</td><td colspan="3">';

                    print $object->profit_margin_rate;

                    print "</td></tr>";
                }else{
                    print '<tr><td class="tdtop">Profit Margin Rate</td><td colspan="3">';

                    print $conf->global->CUSTOM_PRODUCT_PROFITMARGIN;
            ...
            if (! empty($conf->global->CUSTOM_PRODUCT_REBATE))
            {
                if (! empty($object->rebate))
                {
                    print '<tr><td class="tdtop">Rebate</td><td colspan="3">';
                    ...
                    print $conf->global->CUSTOM_PRODUCT_REBATE;
